...
> *la clase EspadaMarina hereda los atributos nombre, rareza, daño, filo y el método atacar() de la clase Espada y luego se le agregamos el nuevo método ataqueTsunami().
